...
if ( ! class_exists( 'TZ_VC_Elements' ) )
{
    /**
     * Class TZ_VC_Elements register new elements for vc
     */
    class TZ_VC_Elements
    {
        public $icons;
        /**
         * TZ_VC_Elements constructor.
         */
        function __construct()
        {
            ...
            {
                vc_add_shortcode_param( 'font-icons', array( $this, 'register_param_icon' ), TZ_TF_JS_URL . 'visual-composer/font-icons.js' );
            }
            else
            {
                return false;
        ...
        public static function icons() {
            ...
            return apply_filters( 'wpf_theme_icons', $icons );
        }
        ...
        function maps()
        {
	        ...
	        vc_map( array(
		        'name'     => esc_html__( 'Custom Text', 'theme_domain' ),
		        'base'     => 'custom_text',
		        'class'    => '',
		        'category' => esc_html__( 'MY THEME', 'theme_domain' ),
		        'params'   => array(
			        array(
				        'type' => 'textarea',
				        'heading' => __( 'Text', 'theme_domain' ),
				        'param_name' => 'text',
				        'admin_label' => true,
				        'value' => __( 'This is custom heading element', 'theme_domain' ),
				        'description' => __( 'Note: If you are using non-latin characters be sure to activate them under Settings/WPBakery Page Builder/General Settings.', 'theme_domain' ),
			        ),
			        array(
				        'type' => 'vc_link',
				        'heading' => __( 'URL (Link)', 'theme_domain' ),
				        'param_name' => 'link',
				        'description' => __( 'Add link to custom heading.', 'theme_domain' ),
			        ...
			        array(
				        ...
				        'settings' => array(
					        'fields' => array(
						        ...
						        'line_height',
						        'color',
						        'tag_description' => __( 'Select element tag.', 'theme_domain' ),
						        'text_align_description' => __( 'Select text alignment.', 'theme_domain' ),
						        'font_size_description' => __( 'Enter font size.', 'theme_domain' ),
						        'line_height_description' => __( 'Enter line height.', 'theme_domain' ),
						        'color_description' => __( 'Select heading color.', 'theme_domain' ),
					        ),
				        ),
			        ),
			        array(
				        'type' => 'checkbox',
				        'heading' => __( 'Use theme default font family?', 'theme_domain' ),
				        'param_name' => 'use_theme_fonts',
				        'value' => array( __( 'Yes', 'theme_domain' ) => 'yes' ),
				        'description' => __( 'Use font family from the theme.', 'theme_domain' ),
			        ),
			        array(
				        'type' => 'google_fonts',
				        ...
				        'settings' => array(
					        'fields' => array(
						        'font_family_description' => __( 'Select font family.', 'theme_domain' ),
						        'font_style_description' => __( 'Select font styling.', 'theme_domain' ),
					        ),
				        ),
				        'dependency' => array(
			        ...
			        array(
				        'type'        => 'textfield',
				        'holder'      => 'div',
				        'heading'     => __( 'Extra class name', 'theme_domain' ),
				        'param_name'  => 'class_name',
				        'value'       => '',
				        'description' => __( 'If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.', 'theme_domain' ),
			        ),
			        array(
				        'heading'    => esc_html__( 'CSS box', 'theme_domain' ),
				        'type'       => 'css_editor',
				        'param_name' => 'css',
				        'group'      => esc_html__( 'Design Options', 'theme_domain' ),
			        ),
		        )
	        ));

	        // Add Distance shortcode use for boostrap 4
	        vc_map( array(
		        'name'     => esc_html__( 'Distance', 'theme_domain' ),
		        'base'     => 'distance',
		        'class'    => '',
		        'category' => esc_html__( 'MY THEME', 'theme_domain' ),
		        'params'   => array(
			        array(
				        'type' => 'textfield',
				        'heading' => esc_html__( 'Input space on extra large devices Desktops (≥1200px)', 'theme_domain' ),
				        'param_name' => 'extra_large_device',
				        'value' => '',
				        'description' => __( 'Enter space (Note: CSS measurement units allowed).', 'theme_domain' ),
			        ),
			        array(
				        'type' => 'textfield',
				        'heading' => esc_html__( 'Input space on large devices Desktops (≥ 992px)', 'theme_domain' ),
				        'param_name' => 'large_device',
				        'value' => '',
				        'description' => __( 'Enter space (Note: CSS measurement units allowed).', 'theme_domain' ),
			        ),
			        array(
				        'type' => 'textfield',
				        'heading' => esc_html__( 'Input space on medium devices tablets (≥768px))', 'theme_domain' ),
				        'param_name' => 'medium_device',
				        'value' => '',
				        'description' => __( 'Enter space (Note: CSS measurement units allowed).', 'theme_domain' ),
			        ),
			        array(
				        'type' => 'textfield',
				        'heading' => esc_html__( 'Input space on small devices Phones ( >576px)', 'theme_domain' ),
				        'param_name' => 'small_device',
				        'value' => '',
				        'description' => __( 'Enter space (Note: CSS measurement units allowed).', 'theme_domain' ),
			        ),
			        array(
				        'type' => 'textfield',
				        'heading' => esc_html__( 'Input space on extra small devices Phones (<576px)', 'theme_domain' ),
				        'param_name' => 'extra_small_device',
				        'value' => '',
				        'description' => __( 'Enter space (Note: CSS measurement units allowed).', 'theme_domain' ),
			        ),
		        ),
        ...
        function register_param_icon( $settings, $value )
        {
            ...
            return sprintf(
                ...
                esc_attr__( 'Quick Search', 'theme_domain' ),
                esc_attr( $value ),
                __( 'Clear Icon Selected', 'theme_domain' ),
